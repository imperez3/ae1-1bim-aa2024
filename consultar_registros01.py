...
# all, significa que se obtiene todos los Restaurants
lista_Restaurant = session.query(Restaurant).all()
# La variable lista_Restaurant, tendrá un listado de objetos de tipo Restaurant.
